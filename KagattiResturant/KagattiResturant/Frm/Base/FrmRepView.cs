...
{
    public partial class FrmRepView : GProjects.Frm.FrmBase
    {
        ...
        public override void IntLanguage()
        {
                ...
                CBase.CurrentLanguage.GetValue(BtnRefresh);
        ...
        {
            SqlDataAdapter adapter = new SqlDataAdapter(SqlQuery, GBase.CBase.Conn);
            dataSet = new DataSet();
