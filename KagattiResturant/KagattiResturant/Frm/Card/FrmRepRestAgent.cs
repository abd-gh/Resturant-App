...
{
    public partial class FrmRepRestAgent : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestAgent()
        {
            InitializeComponent();
        }
        private void FrmRepRestAgent_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        public override string GetSql()
        {
            ...
            return "RepRestAgent '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
