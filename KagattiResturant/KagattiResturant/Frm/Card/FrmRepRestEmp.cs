...
{
    public partial class FrmRepRestEmp : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestEmp()
        {
            InitializeComponent();
        }
        private void FrmRepRestEmp_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        {
            FrmRepViewEmp f = new FrmRepViewEmp();
        ...
        public override string GetSql()
        {
            ...
            return "RepRestEmp '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
