...
{
    public partial class FrmRepRestInvoices : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestInvoices()
        {
            InitializeComponent();
        }
        private void FrmRepRestInvoices_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        public override string GetSql()
        {
            ...
            return "RepRestInvoices '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
