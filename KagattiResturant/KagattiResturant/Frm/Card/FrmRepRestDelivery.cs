...
{
    public partial class FrmRepRestDelivery : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestDelivery()
        {
            InitializeComponent();
        }
        private void FrmRepRestDelivery_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        public override string GetSql()
        {
            ...
            return "RepRestDelivery '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
