...
{
    public partial class FrmRepRestFinal : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestFinal()
        {
            InitializeComponent();
        }
        private void FrmRepRestFinal_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        public override string GetSql()
        {
            ...
            return "RepRestFinal '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
