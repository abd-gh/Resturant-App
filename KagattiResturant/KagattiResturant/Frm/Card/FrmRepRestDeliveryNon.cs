...
{
    public partial class FrmRepRestDeliveryNon : GProjects.Frm.FrmBaseRep
    {
        ...
        public FrmRepRestDeliveryNon()
        {
            InitializeComponent();
        }
        private void FrmRepRestDeliveryNon_Load(object sender, EventArgs e)
        {
            //User Is Admin ?
        ...
        {
            FrmRepViewAgent f = new FrmRepViewAgent();
        ...
        public override void IntLanguage()
        {
            ...
            if (lng == "Ar")
            {
                ProjBase.CurrentLanguage.GetValue(LUser);
        ...
        {
            TUser.Connection.ConnectionString = ProjBase.ConnectionString;
            TUser.GenerateFelidSearch = true;   
            base.intControls();
        ...
        public override string GetSql()
        {
            ...
            return "RepRestDeliveryNon '" + Fdate + "','" + Tdate + "', '" + G.ToString() + "'";
        }
